...
with open('input.txt', 'r+') as f:
  ...
  dimensions=(len(speciesLabels), len(dcLabels)) #Rows by Columns
  inputTable=[list(i) for i in f.read().split('\n')]

def generatePhlyogeneticTree(dcLabels, speciesLabels, dimensions, inputTable):
  #Input Preprocessing
  ...
  #Tree(rootBranch.toNewickString()+';').render("mytree.png")
  return rootBranch.toNewickString()+';'

#generatePhlyogeneticTree(dcLabels, speciesLabels, dimensions, inputTable)